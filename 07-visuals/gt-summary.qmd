...
**Reproducible reports** are an important part of good practices.  We often need to report the **results from a table** in the text of an Quarto report.
...
The `inline_text()` function reports statistics from {gtsummary} tables inline in an Quarto report.
