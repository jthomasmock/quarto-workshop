...
```{r}
flipper_box <- gggplot(data = penguins, aes(x = species, y = flipper_length_mm)) +
...
Include penguin sex: 
```{r}
ggplot(pengins, aes(x = flipper_length_mm,
                            y = body_mass_g)) +
